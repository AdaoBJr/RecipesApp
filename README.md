...
<br>
@[FlavioAndrade](https://github.com/Flavio-Oliveira-Andrade)
<br>
@[JonnesBezerra](https://github.com/JonnesBezerra)
<br>
@[DanielCeci](https://github.com/Daniel-hash-svg)
...
- [Requisitos do projeto](#requisitos-do-projeto)
  ...
  <details>
    ...
    - [52 - Implemente a solução de maneira que o botão de finalizar receita só pode estar habilitado quando todos os ingredientes estiverem "checkados" (marcados)](#52---implemente-a-solução-de-maneira-que-o-botão-de-finalizar-receita-só-pode-estar-habilitado-quando-todos-os-ingredientes-estiverem-checkados-marcados)
...
### 52 - Implemente a solução de maneira que o botão de finalizar receita só pode estar habilitado quando todos os ingredientes estiverem "checkados" (marcados)
